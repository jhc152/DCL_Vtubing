...
namespace VRM.SimpleViewer
{
    ...
    public class ViewerUI : MonoBehaviour
    {
        ...
        static IMaterialDescriptorGenerator GetGltfMaterialGenerator(bool useUrp)
        {
            if (useUrp)
            {
                return null;//new GltfUrpMaterialDescriptorGenerator();
            }
            else
            {
                return null;//new GltfMaterialDescriptorGenerator();
            }
        }
        ...
        static IMaterialDescriptorGenerator GetVrmMaterialGenerator(bool useUrp, VRM.glTF_VRM_extensions vrm)
        {
            if (useUrp)
            {
                return null;//new VRM.VRMUrpMaterialDescriptorGenerator(vrm);
            }
            else
            {
                return null;//new VRM.VRMMaterialDescriptorGenerator(vrm);
            }
        }
